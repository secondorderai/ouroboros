...
| **code-reviewer** | Standards & conventions | Style violations, anti-patterns, deviations from AGENTS.md conventions, potential bugs |
...
- Read the project's AGENTS.md for conventions and standards the agents should check against
...
- The project conventions (from AGENTS.md) — especially the Result<T, Error> pattern,
...
- Read its AGENTS.md or equivalent config for project-specific conventions
