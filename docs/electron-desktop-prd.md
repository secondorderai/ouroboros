...
**Design Spec:** `docs/2026-04-06-electron-desktop-app-design.md`
...
- **`docs/2026-04-06-electron-desktop-app-design.md`** — Approved design spec covering app shell, chat experience, RSI drawer, command palette, onboarding wizard, and platform details.
...
| Design Spec        | `docs/2026-04-06-electron-desktop-app-design.md`  | Approved UI design spec from brainstorming session.                                                  |
...
_End of specification. This document, together with DESIGN.md and the design spec, provides everything needed to implement the Ouroboros desktop application._
